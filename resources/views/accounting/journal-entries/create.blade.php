        ...
        <form id="entryForm">
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="date" class="form-control" id="entry_date" value="{{ date('Y-m-d') }}" required>
                </div>
                <div class="col-md-8">
...
function loadAccounts() {
    $.ajax({
        ...
        success: function(data) {
            ...
            accounts = data;
            // Agregar líneas iniciales DESPUÉS de cargar las cuentas
            addLine();
            addLine();
        },
...
function addLine() {
    ...
    var row = '<tr id="line_' + lineCounter + '">' +
        ...
        '<td><input type="text" class="form-control form-control-sm" name="lines[' + lineCounter + '][description]"></td>' +
        '<td><input type="number" class="form-control form-control-sm text-end debit-input" name="lines[' + lineCounter + '][debit]" value="0" step="0.01" min="0" onchange="handleDebitChange(this)" onkeyup="calculateTotals()"></td>' +
        '<td><input type="number" class="form-control form-control-sm text-end credit-input" name="lines[' + lineCounter + '][credit]" value="0" step="0.01" min="0" onchange="handleCreditChange(this)" onkeyup="calculateTotals()"></td>' +
